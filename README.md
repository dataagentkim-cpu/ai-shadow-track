...
주간 사이클은 별도 크론이 아니라 **봇 프로세스 안의 JobQueue**(`app.job_queue.run_daily(..., days=(0,))`, 매주 월요일 07:00 KST)로 실행되고, 완료되면 결과 요약을 채팅으로 push한다 — running-coach-bot의 `jq.run_daily(weekly_report, ...)` 패턴과 동일.
